...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? ??? 25 16:33:53 2014
# Project:  SUMCoin-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -o Makefile SUMCoin-qt.pro
#############################################################################
...
INCPATH       = -I../../../share/qt4/mkspecs/linux-g++-64 -I../../../include/qt4/QtCore -I../../../include/qt4/QtGui -I../../../include/qt4 -Isrc -Isrc/json -Isrc/qt -Isrc/leveldb/include -Isrc/leveldb/helpers -Ibuild -Ibuild
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -lminiupnpc /usr/local/src/SUMCoin/src/leveldb/libleveldb.a /usr/local/src/SUMCoin/src/leveldb/libmemenv.a -lrt -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
$(TARGET): /usr/local/src/SUMCoin/src/leveldb/libleveldb.a /usr/local/src/SUMCoin/build/build.h build/ui_coincontroldialog.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: SUMCoin-qt.pro  ../../../share/qt4/mkspecs/linux-g++-64/qmake.conf ../../../share/qt4/mkspecs/common/unix.conf \
		../../../share/qt4/mkspecs/common/linux.conf \
		../../../share/qt4/mkspecs/common/gcc-base.conf \
		../../../share/qt4/mkspecs/common/gcc-base-unix.conf \
		../../../share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile SUMCoin-qt.pro
...
/usr/local/src/SUMCoin/src/leveldb/libleveldb.a: FORCE
	cd /usr/local/src/SUMCoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/usr/local/src/SUMCoin/build/build.h: FORCE
	cd /usr/local/src/SUMCoin; /bin/sh share/genbuild.sh /usr/local/src/SUMCoin/build/build.h
